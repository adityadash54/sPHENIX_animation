...
def animate_clusters(data,animation_name="Animated_clusters_TPC.mp4",save=False,start_iteration=0,no_iterations=1):
    ...
    fig_text_sPhenix=ax.text(-100,110,100,  'Au+Au, $\sqrt{s_{NN}}$ = 200 GeV,7fm<b<20fm, 50kHz', size=10,color='w',alpha=0.9)
...
collision_rate=0.05 #MHz #Set fig_text_sPhenix in line 188
...
#ANIMATION
data=read_cluster_pos("Data_files/G4sPHENIX_g4svtx_eval_AuAu_200_7b20.root")
...
iterations = int((no_events-1)*mean_eventtime/1000*time_scale/iteration_time+len_TPC/drift_speed_posz[2])+5
#iterations=50
...
animate_clusters(data,"Animated_clusters_TPC_AuAu.mp4",save=True,start_iteration=0,no_iterations=iterations)
